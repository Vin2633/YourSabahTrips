...
export function SearchBar({ darkMode, onSearch }: SearchBarProps) {
  ...
  const handleSearch = () => {
    if (onSearch) {
      onSearch(selectedLocation, selectedActivity);
    }
  };
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div className="flex items-end">
            <button
              ...
              className="w-full px-6 py-3 bg-[#52b788] text-white rounded-lg hover:bg-[#40916c] transition-colors shadow-lg flex items-center justify-center gap-2"
            >
